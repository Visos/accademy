package com.betcaom.thread.Csv;
...
public class MainCsv implements Runnable {
	...
	public void writeFile(String filePath, List<Users> records) {
	...
	public void run() {
		...
		System.out.println("******************partito thread csv************************");
		...
		System.out.println("***************finito thread csv*******************");
	}
